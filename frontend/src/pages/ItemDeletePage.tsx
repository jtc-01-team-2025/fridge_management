...
export const ItemDeletePage = ({
  ...
  return (
    ...
    <div className="home-container">
      ...
      <div className="item-list-panel" style={{ backgroundColor: "#fff5f5", borderColor: "#feb2b2" }}>
        <h3 style={{ color: "#c53030", marginBottom: "15px" }}>削除する食材を選択してください</h3>
        
        {items.length === 0 ? (
          <p style={{ textAlign: "center", padding: "40px", color: "#999" }}>冷蔵庫は空っぽです。</p>
        ) : (
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
                      ...
                      <div>
                        ...
                        <p style={{ margin: 0, fontSize: "0.8em", color: "#666" }}>期限: {item.date_expiration}</p>
                      </div>
                    </div>
      ...
      {/* 3. 下部の操作エリア */}
      <div style={{ marginTop: "30px", display: "flex", justifyContent: "flex-end", alignItems: "center", gap: "20px" }}>
